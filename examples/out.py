...
def iSort(var_79):
    ...
    match var_79:
        ...
        case [var_10,*var_11]:
            ...
            return_iSort = ((insert (var_10)) ((iSort)(var_11)))
            return return_iSort
    return return_iSort
...
def partitionEithers(var_92):
    ...
    match var_92:
        ...
        case [{ 'a':var_74 },*var_11]:
            (var_93,var_94) = (partitionEithers (var_11))
            
            return_partitionEithers = (plus([var_74])(var_93),var_94)
            return return_partitionEithers
        case [{ 'b':var_74 },*var_11]:
            (var_93,var_94) = (partitionEithers (var_11))
            ...
            def return_posicao(var_97):    
                match var_97:
                    case []:
                        ...
                        return_return_posicao = (var_74,var_54)
                        return return_return_posicao
                    case ['Norte',*var_11]:
                        
                        return_return_posicao = ((posicao ((var_74,plus(var_54)(1)))) (var_11))
                        return return_return_posicao
                    case ['Sul',*var_11]:
                        
                        return_return_posicao = ((posicao ((var_74,minus(var_54)(1)))) (var_11))
                        return return_return_posicao
                    case ['Oeste',*var_11]:
                        
                        return_return_posicao = ((posicao ((minus(var_74)(1),var_54))) (var_11))
                        return return_return_posicao
                    case ['Este',*var_11]:
...
def vizinhos(var_109):
    
    match var_109:
        case { 'x':var_74,'y':var_106 }:
            def return_vizinhos(var_110):    
                match var_110:
                    case []:
                    ...
                    case [{ 'x':var_99,'y':var_100 },*var_11]:
                        var_24 = ((vizinhos ({ 'x' : var_74,'y' : var_106})) (var_11))
...
def mesmaOrdenada(var_111):
    
    match var_111:
        case [{ 'x':_,'y':var_106 },{ 'x':_,'y':var_100 },*var_11]:
            
            if ltgt(var_106)(var_100):
...
print(interseccaoOk(["Vermelho", "Verde"]))