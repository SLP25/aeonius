...
def p_assignment_3(v):
    ...
    v[0] = AssignmentDefinition(v[2], FunctionBody(None, MultiPatternMatch([(v[4], v[5])])))
...
def p_assignment_5(v):
    ...
    v[0] = AssignmentOperator(v[3], FunctionBody(None, MultiPatternMatch([(v[6], v[7])])))
...
def p_nonemptydictexp_2(v):
    ...
    v[0] = NonEmptyDictExpressionContent(v[1].key_value_pairs + [(v[3], v[5])], False)
...
def p_tuplepattern_5(v):
    ...
    v[0] = NonEmptyTuplePatternContent(v[1].patterns + [UnpackPattern(v[4])], False)
...
def p_iterpattern_3(v):
    ...
    v[0] = NonEmptyListPatternContent(v[1].patterns + [UnpackPattern(v[4])], False)
...
def p_nonemptydictpattern_2(v):
    ...
    v[0] = NonEmptyDictPatternContent(v[1].key_value_pairs + [(v[3], v[5])], False)
